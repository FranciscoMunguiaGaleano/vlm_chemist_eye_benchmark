...
if __name__ == '__main__':
    ...
    accuracy_total = 200
    response_time = []
    #query = 'Is the person prone? ONLY reply with YES or NO.'
    query = 'Is the person LYING on the floor or KNEELING or SITTING pr CROUCHING or BENDING OVER or SQUATING DOWN? ONLY reply with YES or NO.'
