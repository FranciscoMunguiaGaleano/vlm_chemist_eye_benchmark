    ...
    try:
        if nonprone:
            ...
            for img_path in image_paths:
                start = time.time()
                answer = get_strict_yes_no_response(img_path, q1, llm)
                if answer == "NO":
                    answer = get_strict_yes_no_response(img_path, q2, llm)
                    if answer == "NO":
                        ...
                        if 'KNEELING' in answer or 'KNEELS' in answer or 'SITTING' in answer or 'CROUCHING' in answer or 'BENDING OVER' in answer or 'BENDING DOWN' in answer or 'SQUATTING DOWN' in answer or 'LYING' in answer:
                            ...
                            print("Warning: LLM gave ambiguous answer after retries. Defaulting to YES to avoid false positives.")
                ...
                if answer == "NO":
                    ...
                    if answer == "NO":
                        ...
                        if 'KNEELING' in answer or 'KNEELS' in answer or 'SITTING' in answer or 'CROUCHING' in answer or 'BENDING OVER' in answer or 'BENDING DOWN' in answer or 'SQUATTING DOWN' in answer or 'LYING' in answer:
                            ...
                            print("Warning: LLM gave ambiguous answer after retries. Defaulting to YES to aviod false positives.")
                            print(f"Ambiguous answer: {answer}")
                            responses_to_invalid.append(answer)
                    else:
                        print("The person is walking")
